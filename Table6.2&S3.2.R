...
setting="b";N=400;d1=100;d2=50;d=d1+d2;tmax=200;K=5;shape1=1;shape2=2;M=floor(N/K);num_est=10;num_totest=num_est+1;nrho=100
...
filename1=paste("predtheta_DTE_b_N",N,"d1",d1,"d2",d2,".RData",sep="")
save(pred_theta,file=filename1)
filename2=paste("predvar_DTE_b_N",N,"d1",d1,"d2",d2,".RData",sep="")
